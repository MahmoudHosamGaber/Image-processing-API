...
describe("test endpoint responses", function () {
    ...
    it("should return a 200(ok) response when the thumbnail exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get("/?image=icelandwaterfall&width=800&height=600")];
                case 1:
                    response = _a.sent();
    ...
    it("should return a 201(created) response when the thumbnail doesn't exists", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request.get("/?image=icelandwaterfall&width=800&height=800")];
                case 1:
                    response = _a.sent();
    ...
    it("should return a 404(not found) when the image is not in the images folder", function () { return __awaiter(void 0, void 0, void 0, function () {
        var response;
        return __generator(this, function (_a) {
            switch (_a.label) {
